...
window.onload = function() {
    ...
    if (clienteCPF) {
        clienteCPF.addEventListener('input', function(e) {
            this.value = mascaraCPF(this.value);
        });
    }
    var clienteTelefone = document.getElementById('clienteTelefone');
    if (clienteTelefone) {
        clienteTelefone.addEventListener('input', function(e) {
    ...
    var formFornecedor = document.getElementById('formFornecedor');
    if (formFornecedor) {
    ...
    // Edição de produto
    var formEditarProduto = document.getElementById('formEditarProduto');
